 ...
 */
export const STATUS_BADGE_CLASSES = "h-7 text-xs px-3 rounded-full font-medium";
 ...
 * Updated: Using flexbox centering instead of padding-y for perfect vertical alignment
 */
export const FEATURED_BADGE_CLASSES = "h-7 text-xs px-2.5 rounded-md font-semibold";
 ...
 * Updated: Using flexbox centering instead of padding-y for perfect vertical alignment
 */
export const OPEN_SOURCE_BADGE_CLASSES = "h-7 text-[11px] px-2.5 rounded-md font-semibold";
 ...
 * Updated: Using flexbox centering instead of padding-y for perfect vertical alignment
 */
export const RECOGNITION_BADGE_CLASSES = "h-7 text-[10px] px-2 rounded-md font-semibold";
 ...
 * Updated: Using flexbox centering instead of padding-y for perfect vertical alignment
 */
export const PRIMARY_METRIC_BADGE_CLASSES = "h-7 text-xs px-3 rounded-full font-semibold";
 ...
 * Updated: Using flexbox centering instead of padding-y for perfect vertical alignment
 */
export const PRIMARY_METRIC_BADGE_MODAL_CLASSES = "h-8 text-sm px-4 rounded-full font-semibold";
